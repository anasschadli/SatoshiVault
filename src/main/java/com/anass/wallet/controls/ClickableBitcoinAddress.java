...
package com.anass.wallet.controls;
...
import com.anass.wallet.utils.QRCodeImages;
...
public class ClickableBitcoinAddress extends AnchorPane implements OverlayController<ClickableBitcoinAddress> {
    ...
    public ClickableBitcoinAddress() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/bitcoinj/walletfx/controls/bitcoin_address.fxml"));
            loader.setRoot(this);
