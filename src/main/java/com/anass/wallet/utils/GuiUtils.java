...
package com.anass.wallet.utils;
...
public class GuiUtils {
    public static void runAlert(BiConsumer<Stage, AlertWindowController> setup) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(GuiUtils.class.getResource("/org/bitcoinj/walletfx/utils/alert.fxml"));
    ...
    public static URL getResource(Class<?> clazz, String name) {
        if (false)
            return unchecked(() -> java.net.URI.create("file:///your/path/here/src/main/wallettemplate/" + name).toURL());
        else
