...
import com.anass.wallet.application.WalletApplication;
import com.anass.wallet.overlay.OverlayController;
import com.anass.wallet.overlay.OverlayableStackPaneController;
import com.anass.wallet.utils.KeyDerivationTasks;
...
import static com.anass.wallet.utils.GuiUtils.checkGuiThread;
import static com.anass.wallet.utils.GuiUtils.fadeIn;
import static com.anass.wallet.utils.GuiUtils.fadeOut;
import static com.anass.wallet.utils.GuiUtils.informationalAlert;
...
public class WalletPasswordController implements OverlayController<WalletPasswordController> {
    ...
    public static Duration getTargetTime() throws IllegalArgumentException {
        ByteString tagValue = WalletApplication.instance().walletAppKit().wallet().getTag(TAG);
        if (tagValue == null) {
            throw new IllegalArgumentException("Target time tag not found in wallet");
        }
        return Duration.ofMillis(longFromByteArray(tagValue.toByteArray()));
    }
