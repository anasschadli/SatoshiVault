...
import com.anass.wallet.controls.BitcoinAddressValidator;
import com.anass.wallet.overlay.OverlayController;
import com.anass.wallet.overlay.OverlayableStackPaneController;
import com.anass.wallet.utils.TextFieldValidator;
import com.anass.wallet.utils.WTUtils;
import org.bitcoinj.wallet.Wallet;
import static org.bitcoinj.base.internal.Preconditions.checkState;
import static com.anass.wallet.utils.GuiUtils.checkGuiThread;
import static com.anass.wallet.utils.GuiUtils.crashAlert;
...
public class SendMoneyController implements OverlayController<SendMoneyController> {
    ...
    public void send(ActionEvent event) {
        ...
        try {
            ...
            Wallet.SendResult result = app.walletAppKit().wallet().sendCoins(req);
            @SuppressWarnings("deprecation")
            TransactionBroadcast broadcast = result.broadcast;
            sendResult = broadcast;
            sendResult.awaitRelayed().whenComplete((broadcastResult, t) -> {
                if (t == null) {
